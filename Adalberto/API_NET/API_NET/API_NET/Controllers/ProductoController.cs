    ...
    public class ProductoController : ControllerBase
    {
                    ...
                    using (var rd = cmd.ExecuteReader())
                    {
                        while (rd.Read())
                        {
                            lista.Add(new Producto
                            {
                                ...
                                Codigo_barra = rd["Codigo_barra"].ToString(),
        ...
        public IActionResult Obtener(int idProducto)
        {
            ...
            try
            {
                ...
                oproducto = lista.Where(item => item.Id_producto == idProducto).FirstOrDefault();
        ...
        public IActionResult Editar([FromBody] Producto objeto)
        {
            try
            {
                using (var conexion = new SqlConnection(cadenaSQL))
                {
                    ...
                    cmd.Parameters.AddWithValue("codigo_barra", objeto.Codigo_barra is null ? DBNull.Value : objeto.Codigo_barra);
